/**
 * @module M/plugin/LocalLayers
 */
import LocalLayersControl from './locallayerscontrol';
import 'assets/css/locallayers';

export default class LocalLayers extends M.Plugin {
   /**
...
addTo(map) {
  ...
  this.control_ = new LocalLayersControl();
  this.panel_ = new M.ui.Panel(LocalLayers.NAME, {
    'collapsible': true,
